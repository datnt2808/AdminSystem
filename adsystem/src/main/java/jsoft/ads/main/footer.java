...
public class footer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("Designed by <a href=\"https://bootstrapmade.com/\">BootstrapMade</a>");
		out.print("</div>");
	    ...
	    //out.print("<script src=\"/adv/vendor/chart.js/chart.min.js\"></script>");
		out.print("<script src=\"/adv/vendor/echarts/echarts.min.js\"></script>");
